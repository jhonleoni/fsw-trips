...
const TripConfirmation = ({ params }: { params: {tripId: string } }) => {
  ...
  if (!res.ok) {
    return toast.error("Ocorreu um erro ao realizar reserva", {position: "bottom-center"})
  }
  ...
  return (
    <div className='container mx-auto p-5'>
      <h1 className='font-semibold text-xl text-primaryDarker'>Sua viagem</h1>
        ...
        {/* CARD */}
      <div className="flex flex-col p-5 mt-5 border-lightGray border-solid border shadow-lg rounded-lg">
        <div className="flex items-center gap-3 pb-5 border-b border-lightGray border-solid">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1 my-1">
              ...
              <p className='text-xs text-darkGray underline'>{trip.location}</p>
            </div>
          </div>
        </div>
