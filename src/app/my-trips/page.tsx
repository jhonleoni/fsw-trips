    ...
    <div className="container mx-auto p-5">
      ...
      {reservations.length > 0 ? (
        ...
        <div className="flex flex-col lg:max-w-[500px]">
          <p className="mt-10 mb-10 font-medium text-primaryDarker text-center">Você ainda não tem nenhuma reserva!</p>

          <Link href="/">
            <Button className="w-full mt-2 mb-60 lg:mt-5">Fazer reserva</Button>
          </Link>
        </div>
      )}
    </div>
